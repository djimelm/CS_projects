...
class Cash {
    ...
    // Setter to update amount based on provided array of counts
    func setBillsAndCoins(_ values: [Int]) {
...
cash1.setBillsAndCoins(array1)
cash2.setBillsAndCoins(array2)
cash3.setBillsAndCoins(array3)
cash4.setBillsAndCoins(array4)
cash5.setBillsAndCoins(array5)
cash6.setBillsAndCoins(array6)
